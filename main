...
def build_car_table(cars):
    """ساخت جدول قیمت خودرو با تمام ستون‌های راست‌چین‌شده."""
    cells = [[
        {"text": "نام خودرو", "is_header": True, "align": "right", "valign": "middle"},
        {"text": "قیمت کارخانه", "is_header": True, "align": "right", "valign": "middle"},
        {"text": "قیمت بازار", "is_header": True, "align": "right", "valign": "middle"},
        {"text": "تفاوت بازار و کارخانه", "is_header": True, "align": "right", "valign": "middle"},
        {"text": "تغییرات", "is_header": True, "align": "right", "valign": "middle"},
    ]]

    for car in cars:
        cells.append([
            {"text": car["name"], "align": "right", "valign": "middle"},
            {"text": car["factory"], "align": "right", "valign": "middle"},
            {"text": car["market"], "align": "right", "valign": "middle"},
            {"text": car["difference"], "align": "right", "valign": "middle"},
            {"text": car["change"], "align": "right", "valign": "middle"},
        ])
...
def get_persian_datetime():
    ...
    return (
        f"بروز رسانی: {day} {month}   {hour}:{minute}"
    )
...
def send_telegram_rich(data):
    ...
    blocks = [
...

        {
            "type": "heading",
            "text": date_text,
            "size": 4,  # کاهش سایز فونت به‌منظور کوچکتر دیده شدن متن تاریخ
        },
