...
def format_price_difference(factory, market):
    ...
    difference = factory_value - market_value
...
def build_car_table(cars):
    """ساخت جدول قیمت خودرو با ستون تفاوت کارخانه و بازار."""
    cells = [[
        ...
        {"text": "تفاوت کارخانه و بازار", "is_header": True, "align": "center", "valign": "middle"},
